...
public class DungeonBuilder : SingletonMonobehaviour<DungeonBuilder>
{
    ...
    {
        // Set dimmed material to fully visible so that in editor we can see the rooms
    ...
    /// <summary>
    /// Attempts to randomly build the dungeon for the specified room node graph. Returns true if a
    ...
    private bool ProcessRoomsInOpenRoomNodeQueue(RoomNodeGraphSO roomNodeGraph, Queue<RoomNodeSO> openRoomNodeQueue, bool noRoomOverlaps)
    {
        ...
        {
            // Get next room node from the open room node queue
            ...
            else // if the room is not an entrance
            {
    ...
    private bool CanPlaceRoomWithNoOverLaps(RoomNodeSO roomNode, Room parentRoom)
    {
        ...
        while (roomOverlaps)
        {
            ...
            {
                // If room odesn't overlap then set to false to exit while loop
                roomOverlaps = false;
    ...
    private RoomTemplateSO GetRandomTemplateForRoomConsistentWithParent(RoomNodeSO roomNode, Doorway doorwayParent)
    {
        ...
        // If room node is a corridor then select random correct Corridor room tample based on
    ...
    private bool PlaceTheRoom(Room parentRoom, Doorway doorwayParent, Room room)
    {
        ...
        {
            // Just mark the parentDoorway as unavailable so we don't try and connect it again
            doorwayParent.isUnavailable = true;
    ...
    /// <summary>
    /// Check if two rooms overlap eachother - return true if they overlap or false if not
    /// </summary>
    ...
    private void LoadRoomTemplatesIntoDictionary()
    {
        ...
        // Load template list in to dictionary
    ...
    private Room CreateRoomFromRoomTemplate(RoomTemplateSO roomTemplate, RoomNodeSO roomNode)
    {
        ...
        // We want to make a deep copy as we don't want to set room.childRoomIDList to equal roomNode.childRoomNodeIDList
