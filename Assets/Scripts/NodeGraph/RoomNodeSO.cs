...
public class RoomNodeSO : ScriptableObject
{
                ...
                if (childRoomNodeIDList.Count > 0)
                {
                    for (int i = childRoomNodeIDList.Count - 1; i >= 0; i--)
                    {
                        ...
                        if (childRoomNode != null)
                        {
                            ...
                            RemoveChildRoomIDFromRoomNode(childRoomNode.id);
    ...
    public bool IsChildRoomValid(string childID)
    {
        ...
        // Check if there is a connected boss room in the node graph
        ...
        // If this childID is already in the parent ID list return false
        ...
        // If a child is a corridor and this node is a corridor return false
        ...
        // If adding a corridor check that this node has < than the maximum permitted child corridors
    ...
    /// <summary>
    /// Remove childID from the node (returns true if the childID has been removed, false otherwise)
    /// </summary>
    public bool RemoveChildRoomIDFromRoomNode(string childID)
    {
